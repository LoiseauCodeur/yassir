 ...
 */
(function ($) {
    $.jstree.plugin("kcheckbox", {
        __init: function () {
            this.data.kcheckbox.noui = this._get_settings().kcheckbox.override_ui;
            if (this.data.ui && this.data.kcheckbox.noui) {
            ...
            this.get_container()
                ...
                .delegate((this.data.ui && this.data.kcheckbox.noui ? "a" : "ins.jstree-checkbox"), "click.jstree", $.proxy(function (e) {
                    e.preventDefault();
        ...
        _fn: {
            ...
            _prepare_checkboxes: function (obj) {
                ...
                var c, _this = this, t, ts = this._get_settings().kcheckbox.two_state, rc = this._get_settings().kcheckbox.real_checkboxes, rcn = this._get_settings().kcheckbox.real_checkboxes_names;
                obj.each(function () {
                    t = $(this);
            ...
            change_state: function (obj, state) {
                ...
                var coll = false, rc = this._get_settings().kcheckbox.real_checkboxes;
                if (!obj || obj === -1) {
                    return false;
                }
                state = (state === false || state === true) ? state : obj.hasClass("jstree-checked");
                if (this._get_settings().kcheckbox.two_state) {
                    if (state) {
                    ...
                    obj.parentsUntil(".jstree", "li").each(function () {
                        ...
                        if (state) {
                            ...
                            if ($this.children("ul").children("li.jstree-unchecked, li.jstree-undetermined").length || $this.data('numchildren') != $this.children("ul").children("li").length) {
                                $this.parentsUntil(".jstree", "li").addBack().removeClass("jstree-checked jstree-unchecked").addClass("jstree-undetermined");
                                if (rc) {
                                    $this.parentsUntil(".jstree", "li").addBack().children(":checkbox").prop("checked", false);
                                }
            ...
            check_node: function (obj) {
                if (this.change_state(obj, false)) {
                    obj = this._get_node(obj);
                    if (this._get_settings().kcheckbox.checked_parent_open) {
                        var t = this;
            ...
            check_all: function () {
                var _this = this,
                    coll = this._get_settings().kcheckbox.two_state ? this.get_container_ul().find("li") : this.get_container_ul().children("li");
                coll.each(function () {
            ...
            get_checked: function (obj, get_all) {
                ...
                return get_all || this._get_settings().kcheckbox.two_state ? obj.find(".jstree-checked") : obj.find("> ul > .jstree-checked, .jstree-undetermined > ul > .jstree-checked");
            },
            get_unchecked: function (obj, get_all) {
                obj = !obj || obj === -1 ? this.get_container() : this._get_node(obj);
                return get_all || this._get_settings().kcheckbox.two_state ? obj.find(".jstree-unchecked") : obj.find("> ul > .jstree-unchecked, .jstree-undetermined > ul > .jstree-unchecked");
            },
            ...
            _repair_state: function (obj) {
                ...
                var rc = this._get_settings().kcheckbox.real_checkboxes,
